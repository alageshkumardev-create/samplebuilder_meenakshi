export const footerPrimaryLinks = [
  'Buy Property in Madurai',
  'Residential Properties Madurai',
  'Commercial Properties Madurai',
  'Real Estate Developers Madurai',
  'House for sale in Madurai',
  'New house for sale in Madurai',
  'Independent house for sale',
  'Individual house for sale',
  'Ready to move house',
  'Buy house in Madurai'
];

export const informationLinkGroups = [
  {
  ...
  {
    id: 'ready-to-move-madurai',
    title: 'Ready to Move Homes in Madurai',
    items: [
      'Ready to Move Villas Madurai',
      'Ready to Move Apartments Madurai',
      'Ready to Move Flats Madurai',
      'Immediate Possession Villas Madurai',
      'Quick Possession Homes Madurai',
      'Ready to Move Houses Madurai',
      'Big Villas Madurai',
      'Ready to Move Residential',
      'Ready to Move Properties',
      'New Ready Homes Madurai'
    ]
  },
  {
    id: 'luxury-premium-madurai',
    title: 'Luxury & Premium Properties in Madurai',
    items: [
      'Luxury Villas Madurai',
      'Luxury Apartments Madurai',
      'Premium Villas Madurai',
      'High-end Homes Madurai',
      'Luxury Real Estate Madurai',
      'Top Luxury Properties Madurai',
      'Luxury Villas for Sale Madurai',
      'Luxury Gated Communities Madurai',
      'Premium Homes Madurai',
      'Exclusive Villas Madurai'
    ]
  },
  {
    id: 'budget-madurai',
    title: 'Budget & Affordable Homes in Madurai',
    items: [
      'Affordable Villas Madurai',
      'Budget Villas Madurai',
      'Affordable Apartments Madurai',
      'Affordable Flats Madurai',
      'Low Budget Plots Madurai',
      'Budget Homes Madurai',
      'Affordable Properties Madurai',
      'Economical Homes Madurai',
  ...
  // },
  {
    ...
    items: [
      ...
      'Ready to move house',
      'Buy house in Madurai',
      'House for sale Avaniyapuram',
      'House in Oomachikulam',
      'House for sale Kochadai',
  ...
  // },
  {
    ...
    items: [
      '4 BHK Villas in Madurai for Sale',
      '3 BHK Villas in Madurai for Sale',
      '4 BHK Independent House for sale in Madurai',
      '3 BHK Independent House in Madurai',
      'Buy 4 BHK Villas in Madurai',
      'Buy 3 & 4 BHK Houses in Madurai',
      '3 BHK and 4 BHK Houses for Sale in Madurai',
      '4 BHK House for Sale in Madurai Avaniyapuram',
      '4 BHK House for Sale in Madurai Oomachikulam',
      '3 & 4 BHK Villas in Madurai Kochadai'
    ]
  },
  {
    id: 'two-bhk-madurai',
    title: '2 BHK Villas & Apartments for Sale in Madurai',
    items: [
      '2 BHK Villas in Madurai for Sale',
      '2 BHK Apartments in Madurai',
      '2 BHK Flats for Sale in Madurai',
      'Buy 2 BHK House in Madurai',
      '2 BHK Gated Community Villas in Madurai',
      '2 BHK Ready to Move Apartments in Madurai',
      '2 BHK Independent House for Sale in Madurai',
      '2 BHK Luxury Apartments in Madurai',
      '2 BHK Budget Homes in Madurai',
